...
with gr.Blocks(title="OmniTech Support") as demo:
    ...
    debug_mode.change(
        toggle_debug_mode,
        inputs=[debug_mode],
        outputs=[agent_tab, mcp_tab, kb_tab, tickets_tab, status_display, tabs]
    )
